...
define('MESSAGE_DATABASE_ERROR', 'DatabaseFactory connection problem.');
define(
    'MESSAGE_EMAIL_ALREADY_EXISTS',
    'This email address is already registered.
    Please use the "I forgot my password" page if you don\'t remember it.'
);
...
define('MESSAGE_NAME_BAD_LENGTH', "Username cannot be shorter than 2 or longer than 255 characters");
